...
This project is a simple demonstration of using a subset of the CouchDB-StORM functions.
...
```
git clone https://github.com/PerfectExamples/CouchDBStORM-Demo.git
cd CouchDBStORM-Demo
swift build
.build/debug/CouchDBStORM-Demo
```
